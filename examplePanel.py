...
class ExamplePanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        # A multiline Text Ctrl - This is here to show how the events work in this program, donIt pay too much attention to it
        ...
        self.editheat = wx.ComboBox(self, pos = (150, 90), size = (95, -1), choices = self.sampleList, style = wx.CB_DROPDOWN)

        # Checkbox
        self.insure = wx.CheckBox(self, label = "Do you wand Insured Shipment?", pos = (20, 180))
